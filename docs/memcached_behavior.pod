...
when this behavior is enabled. The following operations will return
...
Causes libmemcached(3) to use asynchronous IO. This is the fastest transport
...
sorted order. This will defeat consistent hashing.
